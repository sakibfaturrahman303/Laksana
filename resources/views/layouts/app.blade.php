...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default"
    data-assets-path="{{ secure_asset('/') }}assets/" data-template="vertical-menu-template-free">
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ secure_asset('assets/img/laksana.png') }}" />
    ...
    <style>
        ...
        /* Biar tabel selalu full lebar container */
        #dataTable {
            width: 100% !important;
            table-layout: auto !important;
            white-space: nowrap;
            /* Jangan pecah teks ke bawah */
        }

        /* Khusus kolom status dan aksi biar tidak kepotong */
        #dataTable td.aksi,
        #dataTable th.aksi,
        #dataTable td.status,
        #dataTable th.status {
